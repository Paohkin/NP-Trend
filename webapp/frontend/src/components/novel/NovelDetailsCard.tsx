      ...
      <Card.Body>
        <div className="mb-3">
          {details.Tags.map(tag => (
            <Badge pill bg="info" text="dark" className="me-1 fw-bold" key={tag} style={{ fontSize: '0.9rem' }}>
              #{tag}
            </Badge>
          ))}
        </div>

        <div className="d-flex justify-content-start gap-4 text-center my-3">
          <div>
        ...
        <Card.Text className="mt-3 p-3 bg-light rounded" style={{ whiteSpace: 'pre-wrap' }}>
          {details.Synopsis}
        </Card.Text>
